...
export default function Login() {
  return (
    <div className='w-screen h-screen bg-searchGray text-white flex justify-center items-center relative'>
        <div className={`w-96 h-96 ${styles.glass} px-10 flex flex-col items-center z-10`}>
            <span className='mb-10'><Image src='/Herowithoutbg.svg' width={100} height={100} alt="icon" /></span>
            <form className='flex flex-col items-center w-full'>
                <input type="text" name="email" placeholder='Enter your username or email' className='bg-transparent pl-5 border rounded border-white mb-10 w-full h-9 focus:border-none text-black focus:outline-non placeholder:text-gray-900' />
