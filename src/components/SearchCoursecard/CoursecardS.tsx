...
export default function CoursecardS({ title, description, lessons, author, link, category, price, dark, image }: title) {
  return (
    <Link href={`${link}`} className={`flex ${dark && "text-white dark-course-border"} text-black flex-col aspect-square border ${!dark && "shadow-lg"} rounded-xl dark:border-slate-600 lg:hover:scale-[1.1] transition duration-300 p-5`}>
