  ...
  return (
    <>
      <div className="m-0 bg-white">
        ...
        {/* Hero Section */}
        <div
          className={`flex justify-center ${darkMode ? "dark-hero-linear-gradient" : "hero-linear-gradient"} py-[7.1rem] isolate relative overflow-hidden`}>
          <Image
          ...
          <div className=" text-xs absolute top-[8rem] left-[48%] saira hidden xl:block">
            ...
            <p className="my-1 relative">
              ...
              <br /> questions and rely more on your
        ...
        {/* Featured courses */}
        <div
          className={`text-center ${darkMode ? "bg-[#161616]" : "gradient-box"} py-20 relative`}>
          <Image
            src="/Circle.svg"
            width={80}
            height={70}
          ...
          />
          <h1
            className={`rowdies text-3xl ${darkMode ? "text-white" : "text-black"} mb-10`}>
            Featured <span className="text-[#2aaa94]">Courses</span>
          </h1>
          <p
            className={`${darkMode ? "text-slate-100" : "text-[#4e596b]"} saira mb-10`}>
            {" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-1 md:px-[6.7rem] auto-rows-[400px] gap-10 mx-auto max-w-[1280px]">
            {courses.slice(-6).map((course, index) => (
              <div
                ...
                className={`${darkMode ? "bg-transparent border border-slate-200 " : "bg-white text-[#324361] "} transform cursor-pointer hover:scale-[1.03] transition-transform duration-300 rounded-xl`}>
        ...
        <div
          className={`${darkMode ? "dark-btn-linear-gradient" : "btn-linear-gradient"} py-20 text-center flex flex-col items-center relative isolate`}>
          <Image
            src="CircleL1.svg"
            height={90}
            width={90}
