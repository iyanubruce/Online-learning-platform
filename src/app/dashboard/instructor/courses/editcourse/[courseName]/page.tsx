    ...
    <div className="p-5">
      <div className="border border-neutral-500">
        {Lessons.map((lesson, index) => (
          <div key={index}>
            <button
              className="w-full p-2 text-xl flex gap-3 items-center font-bold text-left border rounded"
              onClick={() => {
            ...
            <div
              id={`dropdown` + `${index}`}
              className="hidden p-2 lg:auto-rows-[300px] grid-cols-1 auto-rows-auto"
            >
