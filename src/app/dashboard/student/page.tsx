...
import { logout, resetError, selectAuth } from "@/components/store/authSlice";
      ...
      <div className="flex">
        <main className="flex-1 p-6">
          ...
          <div className="bg-searchGray text-white p-6 rounded-lg shadow-md mb-6">
            ...
            <a
              href="#"
              className="mt-4 inline-block bg-btnColor text-white px-4 py-2 rounded-full"
            >
              Resume Learning
            </a>
          </div>
          ...
          <section className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <CourseRecommendationCard
                description="Leaarn the Essentials of JAvascript"
                lessons={15}
                author="John Smith"
                link="basdfnaskdjn"
